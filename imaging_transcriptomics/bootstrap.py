...
def bootstrap_genes(x_data, y, n_components, y_norm, genes, n_iterations=1000):
    ...
    r1 = correlate(
        results.get("x_scores").reshape(122, n_components), y_norm.reshape(122, 1)
    )
    ...
    for iteration in tqdm(
        ...
        my_resample = np.random.choice(122, size=122)
        x_perm = x_data[my_resample, :]
        y_perm = y[my_resample].reshape(122, 1)
